...
=====================================
Script Purpose:
	This script is designed to create tables in the 
	silver layer of our data warehouse.
*/
...
CREATE TABLE silver.crm_cust_info (
	...
	/* The above line is added to track when the record 
	was inserted into the silver layer, it will be helpful for 
	data lineage and debugging purposes. */
);
